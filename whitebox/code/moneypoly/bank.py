"""Bank module for central game treasury and loan operations."""

from moneypoly.config import BANK_STARTING_FUNDS


class Bank:
    """Represents the central bank handling cash flow during the game."""
    ...
    def give_loan(self, player, amount):
        ...
        if amount > self._funds:
            raise ValueError(
                f"Bank cannot issue loan ${amount}; only ${self._funds} available."
            )
        self._funds -= amount
