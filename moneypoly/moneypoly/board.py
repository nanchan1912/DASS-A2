"""Board module defining tiles, properties, and board-level queries."""
...
class Board:
    ...
    def _create_properties(self):
        ...
        def make_property(name, position, price, base_rent, group):
            prop = Property(name, position, price, base_rent)
            group.add_property(prop)
            return prop

        return [
            make_property("Mediterranean Avenue",   1,  60,  2,  g["brown"]),
            make_property("Baltic Avenue",          3,  60,  4,  g["brown"]),
            make_property("Oriental Avenue",        6,  100, 6,  g["light_blue"]),
            make_property("Vermont Avenue",         8,  100, 6,  g["light_blue"]),
            make_property("Connecticut Avenue",     9,  120, 8,  g["light_blue"]),
            make_property("St. Charles Place",      11, 140, 10, g["pink"]),
            make_property("States Avenue",          13, 140, 10, g["pink"]),
            make_property("Virginia Avenue",        14, 160, 12, g["pink"]),
            make_property("St. James Place",        16, 180, 14, g["orange"]),
            make_property("Tennessee Avenue",       18, 180, 14, g["orange"]),
            make_property("New York Avenue",        19, 200, 16, g["orange"]),
            make_property("Kentucky Avenue",        21, 220, 18, g["red"]),
            make_property("Indiana Avenue",         23, 220, 18, g["red"]),
            make_property("Illinois Avenue",        24, 240, 20, g["red"]),
            make_property("Atlantic Avenue",        26, 260, 22, g["yellow"]),
            make_property("Ventnor Avenue",         27, 260, 22, g["yellow"]),
            make_property("Marvin Gardens",         29, 280, 24, g["yellow"]),
            make_property("Pacific Avenue",         31, 300, 26, g["green"]),
            make_property("North Carolina Avenue",  32, 300, 26, g["green"]),
            make_property("Pennsylvania Avenue",    34, 320, 28, g["green"]),
            make_property("Park Place",             37, 350, 35, g["dark_blue"]),
            make_property("Boardwalk",              39, 400, 50, g["dark_blue"]),
        ]
